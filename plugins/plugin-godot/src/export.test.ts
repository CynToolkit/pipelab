...
describe("Godot export support", () => {
  it("uses the platform-specific template directory", () => {
    expect(godotTemplateDirectories("win32", "C:/Users/test")[0].replaceAll("\\", "/")).toContain("AppData");
    expect(godotTemplateDirectories("darwin", "/Users/test")[0].replaceAll("\\", "/")).toContain("Library/Application Support/Godot");
    expect(godotTemplateDirectories("linux", "/home/test")[0].replaceAll("\\", "/")).toBe("/home/test/.local/share/godot/export_templates");
  });
